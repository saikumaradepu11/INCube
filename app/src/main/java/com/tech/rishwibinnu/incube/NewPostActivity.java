...
public class NewPostActivity extends AppCompatActivity {
    ...
    private EditText newPostDesc,neweventname,newpostlink;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newpostlink = findViewById(R.id.newpost_link);
        ...
        useref.child(current_user_id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists())
                {
                    ...
                    String link=newpostlink.getText().toString();
                    ...
                    if(eventchecker)
                    {
                        postmap.put("type","event");
                    }
                    if(articlechecker)
                    {
                        postmap.put("type","article");
                    }
    ...
    public void onRadioButtonClicked(View view) {
        ...
        switch(view.getId()) {
            case R.id.event_radio:
                if (checked)
                    eventchecker=true;
                    articlechecker=false;
