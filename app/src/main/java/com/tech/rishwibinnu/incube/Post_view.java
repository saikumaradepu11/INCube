...
public class Post_view extends AppCompatActivity {
    ...
    ImageView postimage;
    TextView title,desc,linkdesc,linkname;
    ...
    String eventname,discription,postimage1,databaseuseid,username,htno,mobile,email,branch,year,section;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linkdesc=findViewById(R.id.link_disc);
        ...
        postref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists())
                {
                    ...
                    if(databaseuseid.equals(currentuserid))
                    {
                        edit.setVisibility(View.VISIBLE);
                        delete.setVisibility(View.VISIBLE);
                    }
                    if(dataSnapshot.hasChild("link"))
                    {
                        ...
                        String temp=dataSnapshot.child("link").getValue().toString();
                        linkname.setText(temp);
                        Linkify.addLinks(linkname,Linkify.WEB_URLS);
                    ...
                    if(dataSnapshot.hasChild("type"))
                    {
                        ...
                        if(s1.equals(s2))
                        {
                            regster.setVisibility(View.VISIBLE);
                        }
                    }
