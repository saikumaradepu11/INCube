...
public class HomeFragment extends Fragment {
        ...
        FirebaseRecyclerAdapter<Posts, postsViewholder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Posts, postsViewholder>
            ...
            protected void populateViewHolder(final postsViewholder viewHolder, Posts model, final int position) {
                ...
                viewHolder.comment_text.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent coomenti2=new Intent(getContext(),CommentsActivity.class);
                        coomenti2.putExtra("postkey",postkey);
                        startActivity(coomenti2);
                ...
                viewHolder.profile.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i1=new Intent(getContext(),view_profile.class);
                        i1.putExtra("postkey",postkey);
                        startActivity(i1);
                    }
                });
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists())
                        {
                            if(dataSnapshot.hasChild("type"))
                            {
                                ...
                                if(s1.equals(s2))
                                {
                                    viewHolder.reg.setVisibility(View.VISIBLE);
    ...
    public static class postsViewholder extends RecyclerView.ViewHolder {
        ...
        public postsViewholder(@NonNull View itemView) {
            ...
            register=mview.findViewById(R.id.register_name);
        ...
        public void setProfileimage(final String profileimage) {
            profile = mview.findViewById(R.id.blog_user_image);
